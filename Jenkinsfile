        ...
        stage('Create new docker-agent for making tests'){
            ...
            stages{
                stage('Download and start app'){
                    steps{
                        sh '''curl -X GET -u downloader:downloader "http://192.168.5.11:8081/repository/word-cloud-builds/1/word-cloud-generator/1.$BUILD_NUMBER/word-cloud-generator-1.$BUILD_NUMBER.gz" -o /opt/wordcloud/word-cloud-generator.gz
